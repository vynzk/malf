...
_lr_productions = [
  ...
  ('read_statement -> read ID SEMICOLON','read_statement',3,'p_read_statement','malf.py',94),
  ('if_statement -> if parentesis_izq condition parentesis_der then ENTER statement_list endif SEMICOLON','if_statement',9,'p_if_statement','malf.py',105),
  ('if_statement -> if parentesis_izq condition parentesis_der then ENTER statement_list else ENTER statement_list endif SEMICOLON','if_statement',12,'p_if_statement','malf.py',106),
  ('if_statement -> if parentesis_izq operando_statement parentesis_der then ENTER statement_list endif SEMICOLON','if_statement',9,'p_if_statement','malf.py',107),
  ('if_statement -> if parentesis_izq operando_statement parentesis_der then ENTER statement_list else ENTER statement_list endif SEMICOLON','if_statement',12,'p_if_statement','malf.py',108),
  ('condition -> BOOL','condition',1,'p_condition','malf.py',113),
  ('while_statement -> while parentesis_izq condition parentesis_der do ENTER statement_list wend SEMICOLON','while_statement',9,'p_while_statement','malf.py',118),
  ('while_statement -> while parentesis_izq operando_statement parentesis_der do ENTER statement_list wend SEMICOLON','while_statement',9,'p_while_statement','malf.py',119),
  ('write_statement -> write expression SEMICOLON','write_statement',3,'p_write_statement','malf.py',124),
  ('expression -> ID','expression',1,'p_expression','malf.py',129),
  ('expression -> NUM','expression',1,'p_expression','malf.py',130),
  ('expression -> operando_statement','expression',1,'p_expression','malf.py',131),
  ('operando_statement -> expression OPERATOR expression','operando_statement',3,'p_operando_statement','malf.py',138),
  ('operando_statement -> expression OPERATOR ID','operando_statement',3,'p_operando_statement','malf.py',139),
]
